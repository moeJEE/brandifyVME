                        ...
                        <div class="col-md-5">
                         ...
                         <div class="col-md-7">
                            <div class="slider-image">
                               <img width="450" height="450" class="owl-lazy img-fluid slider-img" src="/img/loading-blog.gif" data-src="{{$slido->photo ? '/images/media/' . $slido->photo->file : '/img/200x200.png'}}" alt="" >
                            </div>
                         </div>
                     </div>
                </div>
                ...
                <div class="card-parent">
                    <div class="card featured to-top-left">
                        ...
                        <div class="image-wrapper to-bottom">
                            <div class="gallery">
                                <img width="400" height="400" class="lazy img-fluid" src="/img/loading-blog.gif" data-src="{{$service->photo ? '/images/media/' . $service->photo->file : '/img/200x200.png'}}" alt="{{$service->title}}">
                            </div>
                        </div>
                            ...
                            <div data-tilt data-tilt-gyroscope="false" data-tilt-scale="1.05" data-tilt-speed="200"  data-tilt-perspective="700" data-hover="" data-tilt-glare="true" data-tilt-max-glare="0.1" data-tilt-max="30"  class="project-box-div">
                                ...
                                <div class="project-image-container">
                                    <div class="project-image-container-inner">
                                        <img class="project-image lazy" width="410" height="230" src="/img/loading-blog.gif " data-src="{{$project->photo ? '/images/media/' . $project->photo->file : '/img/200x200.png'}}" alt="{{$project->title}}">
                                    </div>
                                </div>
